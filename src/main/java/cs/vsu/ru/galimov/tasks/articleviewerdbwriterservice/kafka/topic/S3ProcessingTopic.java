...
@Getter
@Configuration
public class S3ProcessingTopic {

    @Value("${kafka.topic.name.for-s3-topic}")
    private String topicName;

    @Value("${kafka.topic.partitions.for-s3-topic}")
    private int numPartitions;

    @Value("${kafka.topic.replication-factor.for-s3-topic}")
