...
public class ArticleMapper {
    public Article convertJsonToArticle(JsonObject jsonObject) {
        ...
        JsonObject archiveJson = jsonObject.getAsJsonObject("archive");
        String archiveLink = archiveJson.get("link").getAsString();
        String archiveType = archiveJson.get("type").getAsString();
        ...
        article.setDepartmentMagazine(new DepartmentMagazine(departmentMagazineName, departmentMagazineUrl));
        article.setArchive(new Archive(archiveLink, ArchiveType.valueOf(archiveType)));
